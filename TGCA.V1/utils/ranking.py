...
class Ranking:
    def __init__(self, positive_file_name = None, negative_file_name = None, evaluation = 'None'):
        module_dir = os.path.dirname(__file__)
        self.positive_file_path = str(module_dir).replace('\\','/').replace('utils','datas') + '/' + positive_file_name + '.csv'
        self.negative_file_path = str(module_dir).replace('\\','/').replace('utils','datas') + '/' + negative_file_name + '.csv'
